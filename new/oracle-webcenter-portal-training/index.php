...
<head>
            ...
            <div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(../assets/back1.png)">
				...
				<div class="col-lg-8 text-center">
                    <div class="c-page-title ">
                        <h1 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim"  style="font-size:30px;">Oracle WebCenter Portal Training</h1>  
                    </div>
									</div>
				<div class="col-lg-2">
				</div>
                        ...
                        <div class="col-sm-12  ">
                           <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1">
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Introduction to Oracle WebCenter 12C</h3>
						...
						<div class="col-sm-12  ">
                           <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Oracle Jdeveloper and ADF</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Configure Partial Page Refresh
						...
						<div class="col-sm-12  ">
                           <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Oracle WebCenter Framework</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Build and Deploy a Portlet 
						...
						<div class="col-sm-12  ">
                           <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">WebCenter Portlets</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
...
Oracle JSF Portlet Bridge
						...
						<div class="col-sm-12  ">
                           <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Oracle Composer</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
	...
	Customize at Design Time – Add Styles and Create new
						...
						<div class="col-sm-12  ">
                           <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">WebCenter Services</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Configure and use Search
						...
						<div class="col-sm-12  ">
                           <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Integrating Content</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
