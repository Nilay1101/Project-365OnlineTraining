...
<head>
					...
					<div class="col-lg-8">
						...
						<div class="col-sm-12  ">
                            ...
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Architecture and Interfaces</h3>
    ...
    The Contributor Interface : Content Creation</li>
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Creating and Configuring a New CM Site</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Creating and Assigning Roles in the WEM Admin Interface to a Site.
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Asset Model</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    About Asset Dependencies
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Oracle WebCenter Sites Programming</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Building Links to ../assets
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Oracle WebCenter Sites Programming – Cont.</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Template calling stack.
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">In Context Editing: Web Mode</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Coding for In-Context Content Creation
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">WebCenter Sites Developer Tools and Tags</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Template Creation and Integration with Eclipse
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Workflows</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Configuration of Email, states and Workflow process
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Revision Tracking and Publishing</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Approving and Publishing Content ../assets
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Caching Strategy</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Working with Embedded Pagelets
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Software Required</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
							<p>11 g</p>
    ...
    Notepad ++
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Hardware Requirements</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
...
Min. 8 GB RAM
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Training Material</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Sample site as an Assignment
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">How in engage in Oracle WebCenter Sites Training</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
...
<a id="get-youtube-data" class="youtube-embed-code" href="https://www.tubeembed.com">tubeembed</a>
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Users, Roles and ACL Tutorial</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                           <div style="overflow: hidden; height: 270px; width: 740px; max-width: 100%; max-height: 100%;">
...
<a id="get-youtube-data" class="youtube-embed-code" href="https://www.tubeembed.com">tubeembed</a>
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Basic Asset Types Tutorial</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                           <div style="overflow: hidden; height: 270px; width: 740px; max-width: 100%; max-height: 100%;">
...
<a id="get-youtube-data" class="youtube-embed-code" href="https://www.tubeembed.com">tubeembed</a>
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">How to resolve Webcenter sites 12C eclipse plugin not getting visible in eclipse issue</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                           <div style="overflow: hidden; height: 270px; width: 740px; max-width: 100%; max-height: 100%;">
