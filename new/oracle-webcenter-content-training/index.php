...
<head>
            ...
            <div class="c-layout-breadcrumbs-1 c-bgimage c-subtitle c-fonts-uppercase c-fonts-bold c-bg-img-center" style="background-image: url(../assets/back1.png)">
				...
				<div class="col-lg-8 text-center">
                    <div class="c-page-title ">
                        <h1 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim"  style="font-size:30px;">Oracle WebCenter Content Training</h1>  
                    </div>
									</div>
				<div class="col-lg-2">
				</div>
					...
					<div class="col-lg-8">
						...
						<div class="col-sm-12  ">
                            ...
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Introducing Oracle WebCenter Content Training</h3>
    ...
    Introducing What can be Customized
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">WebCenter Security</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    WebLogic user and Groups
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">WebCenter Content Server Administration</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Workflow
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Using Component Wizard</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Identifying Files Created in a Component and the Resulting Directory Structure
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Idoc Script</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Using Idoc Script to Alter the Presentation of the Content Server
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Component and Glue File</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    The Template Resource
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Creating a New Layout and Skin</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Creating a Custom Skin
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Using Dynamic Server Pages as Alternatives to Custom Components</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Creating an HCST Dynamic Server Page (*.hcst)
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Overview of Java Customization</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Introducing JDeveloper
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Integrating Custom Java Code Into the Oracle WebCenter Content Server</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Creating a Custom Component Tracing Section
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Creating Custom Idoc Script Functions and Variables with Java Code</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <ul class="c-content-list-1 c-theme  c-font-uppercase">
    ...
    Deploying the Idoc Script Extension With JDeveloper
						...
						<div class="col-sm-12  ">
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Oracle WebCenter Content Demo</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
...
<a id="get-youtube-data" class="youtube-embed-code" href="https://www.tubeembed.com">tubeembed</a>
                            ...
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Desktop Integration</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <div style="overflow: hidden; height: 270px; width: 740px; max-width: 100%; max-height: 100%;">
...
<a id="get-youtube-data" class="youtube-embed-code" href="https://www.tubeembed.com">tubeembed</a>
                            ...
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Content Type Creation</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <div style="overflow: hidden; height: 270px; width: 740px; max-width: 100%; max-height: 100%;">
...
<a id="get-youtube-data" class="youtube-embed-code" href="https://www.tubeembed.com">tubeembed</a>
                            ...
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">User Creation</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <div style="overflow: hidden; height: 270px; width: 740px; max-width: 100%; max-height: 100%;">
...
<a id="get-youtube-data" class="youtube-embed-code" href="https://www.tubeembed.com">tubeembed</a>
                            ...
                            <!-- Begin: Title 1 component -->
                            <div class="c-content-title-1"></br>
                                <h3 class="c-font-uppercase c-font-bold" style="font-size:25px">Localization</h3>
                                <div class="c-line-left c-theme-bg"></div>
                            </div>
                            <!-- End-->
                            <div style="overflow: hidden; height: 270px; width: 740px; max-width: 100%; max-height: 100%;">
                    ...
                    <div class="c-body">
						...
						<div class="col-md-8 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12">
                                ...
                                <p class="c-address c-font-16"> Phone: +91-9448-481-470
