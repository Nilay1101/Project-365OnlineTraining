...
<li class="consultancy-dd-list"><a href="#"><small>Oracle WebCenter Sies 11g :  How to make left side admin tab work in Mozilla Firefox Browser</small></a></li>
		...
		<div class="nav-wrap col-sm-2 col-xs-2" style="font-family: 'Raleway', sans-serif;"><button onclick="location.href='http://365onlinetraining.com/project-consultancy/';" class="about-us"><a href="http://365onlinetraining.com/project-consultancy/">Project Consultancy</a></button></div>
